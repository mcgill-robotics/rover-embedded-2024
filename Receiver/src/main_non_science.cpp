...
//   }
//   else if (stepper_position == 2)
//   {
//     science_data_msg.data[1] = geiger_loop();
//   }
//   else if (stepper_position == 4)
//   {
//     science_data_msg.data[2] = geiger_loop();
//   }
//   else if (stepper_position == 6)
//   {
//     science_data_msg.data[3] = geiger_loop();
//   } // geiger moiste ph
// }
...
// { // keeps track of position of stepper(0 to 7)
//   if (stepper_position == 7)
//   {
//     stepper_position = 0;
//   }
//   else
...
// void auger_up()
// { // rotates auger CW for 15 sec
//   digitalWrite(dir1, HIGH);
//   analogWrite(pwm1, 80);
// }

// void auger_down()
// { // rotates auger CCW for 15 sec
...
//   {
//     screw_down();
//   } // goes all the way to bottom
//   else if (screw == 1)
//   {
//     screw_up();
//   } // goes all tge way to top
