...
#define REG_KD_WRIST_ROLL 0.2f
// #define REG_KD_WRIST_ROLL 0.02f
#define REG_KP_WRIST_ROLL_AGG 0.2f
#define REG_KI_WRIST_ROLL_AGG 0.1f
#define REG_KD_WRIST_ROLL_AGG 0.2f
#define WRIST_ROLL_MIN_ANGLE -200.0f
#define WRIST_ROLL_MAX_ANGLE 200.0f
#define WRIST_ROLL_GEAR_RATIO 2.672222f
#define WRIST_ROLL_ZERO_ANGLE 270.0f

// WRIST_PITCH_CYTRON
#define REG_KP_WRIST_PITCH 0.7f
#define REG_KI_WRIST_PITCH 1.8f
#define REG_KD_WRIST_PITCH 0
#define REG_KP_WRIST_PITCH_AGG 1.0f
...
#define WRIST_PITCH_ZERO_ANGLE (323.0f + (-1.0f * 360.0f))
...
// ELBOW_SERVO
#define REG_KP_ELBOW 1.2f
#define REG_KI_ELBOW 0.3f
#define REG_KD_ELBOW 0
#define REG_KP_ELBOW_AGG REG_KP_ELBOW
#define REG_KI_ELBOW_AGG REG_KI_ELBOW
#define REG_KD_ELBOW_AGG REG_KD_ELBOW
// #define REG_KP_ELBOW_AGG 0.8f
// #define REG_KI_ELBOW_AGG 1.0f
// #define REG_KD_ELBOW_AGG 0
#define ELBOW_MIN_ANGLE -20.0f
#define ELBOW_MAX_ANGLE 70.0f
#define ELBOW_ZERO_ANGLE (240.0f + (0 * 360.0f))
#define ELBOW_ANGLE_STRAIGHT -90.0f
#define ELBOW_GEAR_RATIO 1.0f

// SHOULDER_SERVO
#define REG_KP_SHOULDER 2.0f
#define REG_KI_SHOULDER 1.0f
#define REG_KD_SHOULDER 1.8f
#define REG_KP_SHOULDER_AGG REG_KP_SHOULDER * 1.2f
#define REG_KI_SHOULDER_AGG REG_KI_SHOULDER * 1.2f
#define REG_KD_SHOULDER_AGG REG_KD_SHOULDER
#define SHOULDER_MIN_ANGLE -50.0f
#define SHOULDER_MAX_ANGLE 70.0f
#define SHOULDER_ZERO_ANGLE 85.0f + (-256.0f * 360.0f)
#define SHOULDER_ANGLE_STRAIGHT 0

// WAIST_SERVO
#define REG_KP_WAIST 0.2f
#define REG_KI_WAIST 1.5f
#define REG_KD_WAIST 0
#define REG_KP_WAIST_AGG 0.3f
#define REG_KI_WAIST_AGG 2.0f
