...
# TODO apply config from google docs
...
while True:
    ...
    print("goto " + str(int(setpoint)), "currently at " + str(my_drive.amt21_encoder_group0.raw), " state " + str(my_drive.axis0.current_state))
    my_drive.axis0.controller.input_pos = setpoint
    odrive.dump_errors(my_drive)
    time.sleep(0.01)
