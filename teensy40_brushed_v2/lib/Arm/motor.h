...
struct MotorState 
{
    ...
    */
    MotorState(double vel, double torque):
    vel(vel),
    torque(torque)
    {}
    double vel;
...
struct ArmPose
{
    ...
    */
    ArmPose(Rotation2d shoulder, Rotation2d elbow, Rotation2d wrist):
    shoulder(shoulder),
    elbow(elbow),
    wrist(wrist)
    {}
...
struct JointProperties
{
    ...
    */
    JointProperties (double mass, double cm_x, double cm_y, double length):
    mass(mass),
    cm_pos(cm_x,cm_y),
    length(length)
    {
     ...
     * @param length The length of the joint in m.
    */
    JointProperties (double mass, Vector2d cm, double length):
    mass(mass),
